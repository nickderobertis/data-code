...
# TODO: decouple get CRSP from data paths before getting these tests working
...
#
#         dse = datacode.merge_dsenames(self.ticker_df, other_byvars='byvar') #default is on ticker get permno
#
...
#
#         dse = datacode.merge_dsenames(self.df_ticker_extra_cols_year_month, other_byvars='byvar')
#
#         assert_frame_equal(expect_df, dse)

# TODO: decouple get CRSP from data paths before getting get gvkey or permno tests working
...
# TODO: decouple get FF from data paths before getting these tests working
...
#
#         ga = datacode.get_abret(indf, ['PERMNO','byvar'], freq='d', abret_fac=1)
#
...
#
#
#     crsp = datacode.GetCRSP(debug=True)
#
#
...
# TODO: decouple get Compustat from data paths before getting these tests working
